...
from a2c_trpo_ppo_acktr.utils import get_render_func, get_vec_normalize

sys.path.append('a2c_trpo_ppo_acktr')

parser = argparse.ArgumentParser(description='See the trained policy in action!')
...
while True:
    with torch.no_grad():
        value, action, _, recurrent_hidden_states = actor_critic.act(obs,
